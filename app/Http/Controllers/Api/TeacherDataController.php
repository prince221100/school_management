...
class TeacherDataController extends Controller
{
    ...
    public function edit_teacherdetails(Request $request,$id){
    ...
    public function delete_teacherdetails($id){
        $data = Admin::find($id);
        // echo($data->id);
        if($data){
    ...
    public function showteacher(){
        ...
        if($data){
            return response()->json(['message'=>'All Teachers Data','status'=>1,'data'=>$data],200);
