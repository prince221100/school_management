...
<tbody>
    ...
    <tr>
        ...
        <div class="actions">
        <a href="/editclassstudent/{{$tdata->id}}" class="btn btn-sm bg-success-light mr-2 edit">
            {{-- <i class="fas fa-pen"></i> --}}Edit
            </a>

            <a href="/delclassstudent/{{$tdata->id}}" class="btn btn-sm bg-danger-light mr-2 del">Delete</a>
