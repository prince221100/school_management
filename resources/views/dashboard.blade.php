                        ...
                        <ul class="notification-list">
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    ...
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('frontend/img/profiles/avatar-02.jpg')}}">
                                    </span>
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('frontend/img/profiles/avatar-11.jpg')}}">
                                    </span>
                                    <div class="media-body">
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('frontend/img/profiles/avatar-17.jpg')}}">
                                    </span>
                                    <div class="media-body">
                           ...
                           <li class="notification-message">
                              <a href="#">
                                 <div class="media">
                                    <span class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle" alt="User Image" src="{{ url('frontend/img/profiles/avatar-13.jpg')}}">
                                    </span>
                                    <div class="media-body">
               ...
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li class="submenu">
                        ...
                        <ul>
                            <li><a href="{{url('/addteacher/create')}}">Teacher Add</a></li>
                     ...
                     <li class="submenu">
                        <a href="#"><i class="fas fa-building"></i> <span>Assign Class Teacher</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{Route('assignclassteacher')}}">Add Teacher Class </a></li>
                           <li><a href="{{Route('showdata')}}">Show Data</a></li>
         ...
         <div class="page-wrapper">
            <div class="content container-fluid">
                <div class="page-header">
                   <div class="row">
                      <div class="col-sm-12">
                         <h3 class="page-title">Welcome {{session('fname')}} <h3>
                         <ul class="breadcrumb">
