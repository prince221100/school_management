{{-- <!DOCTYPE html>
<html lang="en">
   <!-- Mirrored from preschool.dreamguystech.com/html-template/form-vertical.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Oct 2021 11:12:03 GMT -->
   <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
      <title>Profile</title>
      <link rel="shortcut icon" href="{{ url('frontend/js/script.js')}}assets/img/favicon.png">
      ...
      <link rel="stylesheet" href="{{ url('frontend/plugins/fontawesome/css/all.min.css')}}assets/">
   ...
   <body>
      ...
      <script src="{{ url('frontend/plugins/select2/js/select2.min.js')}}"></script>
                ...
                <div class="card-body">
                   <form action="{{Route('update_profile')}}" method="POST">
                    @csrf
                      <div class="form-group">
                         <label>First Name</label>
                         <input type="text" class="form-control" value="{{$data->firstname}}" name="fname">
                      </div>
                      <div class="form-group">
                         <label>Last Name</label>
                      ...
                      <div class="form-group">
                         <label>Email Address</label>
                         <input type="email" class="form-control" value="{{$data->email}}" name="email" disabled >
                      </div>
                      <div class="form-group">
                         <label>Mobile No.</label>
                         <input type="text" class="form-control" value="{{$data->mobileno}}" name="mno" maxlength="10">
                      </div>
                      <div class="form-group">
                         <label>Password</label>
