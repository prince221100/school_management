...
<select name="classname"  class="col-12 col-sm-12">
    <option selected disabled>Please Select Class & Subject</option>
@foreach ( $classinfo as $classname )
...
<div class="col-12 col-sm-4">
    <div class="form-group">
    <label>Date</label><br>
    <input type="date" name="date" class="col-12 col-sm-12" id="date">
    ...
    <div class="col-12 col-sm-4">
        ...
        <label>Start time</label><br>
            <input type="time" name="starttime" class="col-12 col-sm-12">
        @error('starttime')
        <span style="color: red">{{ $message }}</span>
        @enderror
        </div>
        ...
        <div class="col-12 col-sm-4">
            ...
            <label>End time</label><br>
                <input type="time" name="endtime" class="col-12 col-sm-12">
